...
outputPow = -5;
sensRange = -20;
lambdaList = {[1510 1580], [1580 1640]};                            %start and stop wavelengths
lambda_step = 0.02;                                                 %step size of the sweep
fileBeginning = 'testing3__apr03';
%measurementType = 1; %detector measurement unit, set to 0 for DBM, set to 1 for Watts

laserType = 1; %% set to 0 for the keysight setup, set to 1 for the agilent setup
%% adjustable parameters----------------------
